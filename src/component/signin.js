...
const signin = (visible,onClose) => {
  ...
  return (
    <div className=' w-1/3 inset-0 bg-opacity-60 shadow-2xl backdrop-blur-sm fixed flex justify-center rounded-xl 
      bg-gradient-to-r from-indigo-500 to-violet-500  items-center text-center mx-auto my-10 h-96'>
    <div className=' flex-col flex-wrap w-96  h-auto '>
        ...
        name='name'/>
        <br />	
        <input type="text" className='my-3 border-2 rounded-lg border-black p-1 w-auto text-indigo-600 font-semibold' placeholder="Enter your E-mail" 
        name='Phone_number'/>
        <br />
        <input type="email" className='my-3 border-2 rounded-lg border-black p-1 w-auto text-indigo-600 font-semibold' placeholder="Enter your Password"
        name='email'/>
        <br />
