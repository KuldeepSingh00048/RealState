  ...
  return (
    <>
          ...
          <ul className='bg-white flex flex-wrap w-fit rounded-xl  mx-auto p-auto mt-4 '>
            ...
            <li className=' flex-col mx-2 py-0 px-4 text-center justify-center border-r-2  '>
              ...
              >
                ...
                <option value='Rs.30 L - Rs.35 L' className='text-sm text-left text-black font-bold  '>Rs.30 L - Rs.35 L</option>
                <option value='Rs.35 L - Rs.45 L' className='text-sm text-left text-black font-bold  '>Rs.35 L - Rs.45 L</option>
                <option value='Rs.45 L - Rs.65 L' className='text-sm text-left text-black font-bold  '>Rs.45 L - Rs.65 L</option>
              </select>
              {/* <h2 className='flex text-sm'>Price<MdOutlineArrowDropDown className='h-5 w-7'/></h2> */}
            </li>
            <li className=' flex-col mx-2 py-0 px-4 text-center justify-center border-r-2 '>
      ...
      <div className='h-96 flex gap-16 flex-wrap overflow-hidden overflow-y-auto rounded-xl p-2 border-2 justify-center bg-gray-100'>
        {
          items.map((elem) => {
            const { id, himage, hprice, hname, hlocation, hbed, hbath, harea } = elem;
            return (
              <div className=' flex border-b-2 h-48 bg-white rounded-xl w-auto border-b-indigo-500'>
                ...
                <div className='w-60 '>
                  <div className='flex px-2'>
                    <h1 className=' py-2  text-violet-600 font-extrabold text-lg'>Rs. {hprice}</h1>
                  </div>
