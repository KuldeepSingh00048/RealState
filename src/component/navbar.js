        ...
        <>
            <nav className=' flex flex-wrap h-auto pt-4 pb-4 rounded-xl border-b-2 border-b-purple-300 shadow-md m-4 border-2'>
                ...
                <div className=' px-4 py-3 ml-auto'>
                    <button onClick={() => setSignup(true)} className='mx-2 bg-indigo-500 border-indigo-500  border-2 px-2  font-bold text-white rounded-lg hover:bg-white hover:text-indigo-500 text-xl'>Sign Up</button>
                    <button onClick={() => setSignin(true)} className='mx-2 bg-violet-600 border-violet-600  border-2 px-2  font-bold text-white rounded-lg hover:bg-white hover:text-violet-600 text-xl'>Sign In</button>
                </div>
                    <Signup onClose={closeSignup} visible={signup} />
                    <Signin onClose={closeSignin} visible={signin} />
            </nav>
        </>
    )
}
